...
void changBrightnessForPeriod(int brightness, int period) {
  ...
  analogWrite(LED3, mapHundredToEightBit(brightness));
  analogWrite(LED4, mapHundredToEightBit(brightness));
  publishBrightness(100, 1);
  publishBrightness(100, 2);
  publishBrightness(100, 3);
  publishBrightness(100, 4);
  delay(period);
  analogWrite(LED1, mapHundredToEightBit(5));
  analogWrite(LED2, mapHundredToEightBit(5));
  analogWrite(LED3, mapHundredToEightBit(5));
  analogWrite(LED4, mapHundredToEightBit(5));
  publishBrightness(5, 1);
  publishBrightness(5, 2);
  publishBrightness(5, 3);
  publishBrightness(5, 4);
}
